		...
		>
			<div className='relative mx-auto w-56'>
				<div className='absolute top-6 -right-[2px] flex flex-col gap-1.5'>
					<div className='h-5 w-[2px] rounded-r-sm bg-neutral-300' />
					<div className='h-5 w-[2px] rounded-r-sm bg-neutral-300' />
				</div>
				<div className='absolute -top-[2px] right-10'>
					<div className='h-[2px] w-6 rounded-t-sm bg-neutral-300' />
				</div>

				<div className='rounded-[1rem] bg-neutral-200 p-1 shadow-sm ring-1 shadow-black/5 ring-black/5'>
					<div className='relative h-36 w-full overflow-hidden rounded-[0.75rem] bg-white'>
						<motion.div
