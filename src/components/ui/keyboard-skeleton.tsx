...
export function KeyboardSkeleton({ className }: { className?: string }) {
	return (
		...
		>
			<div className='rounded-xl bg-neutral-200 p-[3px] shadow-sm ring-1 ring-black/5'>
				<Row>
					...
					<Key className='rounded-tr-lg'>
						<div className='size-1.5 rounded-full bg-linear-to-b from-neutral-300 via-neutral-200 to-neutral-300 p-px'>
				...
				<Row>
					...
					<div className='flex h-3 items-center gap-px rounded-[2px]'>
						...
						<Key className='h-3 w-3 rounded-br-lg'>
							→
						</Key>
					</div>
				</Row>
